...
Source0  : https://distfiles.audacious-media-player.org/audacious-4.3.tar.bz2
...
%prep
%setup -q -n audacious-4.3
cd %{_builddir}/audacious-4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678201813
...
/usr/lib64/libaudcore.so.5.4.0
/usr/lib64/libaudgui.so.5
/usr/lib64/libaudgui.so.5.2.0
