...
Source0  : https://distfiles.audacious-media-player.org/audacious-4.1.tar.bz2
...
%prep
%setup -q -n audacious-4.1
cd %{_builddir}/audacious-4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633121345
...
/usr/lib64/libaudcore.so.5.3.0
/usr/lib64/libaudgui.so.5
/usr/lib64/libaudgui.so.5.1.0
/usr/lib64/libaudqt.so.2
/usr/lib64/libaudqt.so.2.3.0
